...
public class Covid19Pacient extends Observable {
	...
	private FactorySymptom factorySymptom;

	public Covid19Pacient(String name, int years, FactorySymptom fact) {
		this.name = name;
		this.age = years;
		this.factorySymptom = fact;
	}
	...
	private Symptom createSymptom(String symptomName) {
		return factorySymptom.createSymptom(symptomName);
	}
}
